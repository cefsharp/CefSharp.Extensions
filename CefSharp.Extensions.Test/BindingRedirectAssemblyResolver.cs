...
namespace CefSharp.Extensions.Test
{
    ...
    internal class BindingRedirectAssemblyResolver : IDisposable
    {
        ...
        private static Assembly CurrentDomainAssemblyResolve(object sender, ResolveEventArgs args)
        {
            ...
            var path = Path.Combine(Environment.CurrentDirectory, bitness, asemblyName.Name + ".dll");
            ...
            path = Path.Combine(Path.GetDirectoryName(Assembly.GetExecutingAssembly().Location), bitness, asemblyName.Name + ".dll");
